...
const Header = () => {
  ...
  const options = [
    ...
    { label: "Wheat", value: "2" },
    { label: "Maize", value: "3" },
    { label: "Pink Salt", value: "4" },
    { label: "Meat", value: "5" },
    { label: "Scrap", value: "6" },
    { label: "Surgical Instrument", value: "7" },
    { label: "Towel & Bed Sheets", value: "8" },
    { label: "Bed Sheets", value: "9" },
  ];
  const handleCategoryChange = (selectedValue: string) => {
    if (selectedValue === "0") {
      router.push("/"); // Direct back home if "All Categories" is picked
    } else {
      router.push(`/category/${selectedValue}`); // e.g., /category/1 for Rice
    }
  };
      ...
      <div className="max-w-[full] mx-4 px-4 sm:px-7.5 xl:px-0">
        ...
        >
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            ...
            <ul className="flex xl:items-center flex-row gap-5 xl:gap-6">
          ...
          <div className="max-w-[475px] w-full">
              <form>
                <div className="flex items-center">
                  <CustomSelect options={options} onSelectOption={(option: { label: string, value: string }) => handleCategoryChange(option.value)} />
          ...
          {/* <!-- header top right --> */}
          <div className="flex w-full flex-row lg:w-auto items-center gap-7.5">
            ...
            <div>
                <p className="font-large ttext-custom-lg  text-dark">
                  (+92) 3219959819
                </p>
              </div>
